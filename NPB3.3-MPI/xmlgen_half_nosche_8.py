        ...
        for r1, r2 in edgelist:
          if (r1 >= 8 and r2 >= 8):
            if (r1 < (8 + non_zero_groups) and G.degree[r1] >= 3):
              f.write(link_router_router_upper.format(r1, r2, int((G.degree[r1] - 1) * 500000000)))
            elif (r2 < (8 + non_zero_groups) and G.degree[r2] >= 3):
              f.write(link_router_router_upper.format(r1, r2, int((G.degree[r2] - 1) * 500000000)))
            else:
              f.write(link_router_router_upper.format(r1, r2, int(500000000)))
          else:
