...
link_router_router_upper = """  <link id='links{0}s{1}_powered' bandwidth='80000000000.0' latency='2.0852e-06'/>
"""
...
route_router_router_upper = """  <route src='s{0}' dst='s{1}' symmetrical='NO'>
   <link_ctn id='links{2}s{3}_upper'/>
  </route>
"""
...
if __name__ == "__main__":
    ...
    with open(os.path.join(out_dir, out_xml), "w") as f:
        ...
        for r1, r2 in edgelist:
            if (r1 >= 64 ) and (r2 >= 64):
              f.write(link_router_router_upper.format(r1, r2))
            else:
        ...
        for r1, r2 in edgelist:
            if (r1 >= 64 ) and (r2 >= 64):
              f.write(route_router_router_upper.format(r1, r2, r1, r2))
              f.write(route_router_router_upper.format(r2, r1, r1, r2))
            else:
